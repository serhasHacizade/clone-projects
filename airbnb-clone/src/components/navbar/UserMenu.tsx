    ...
    return (
        <div className="relative">
            <div className="flex flex-row items-center gap-3">
                ...
                <div onClick={toggleOpen} className="py-4 md:py-1 md:px-2 border-[1px] border-neutral-200
            ...
            {isOpen && (
                <div className="absolute rounded-xl shadow-md w-[40vw] bg-white overflow-hidden
