        ...
        <div class="py-2 w-full">
            <div class="flex items-center justify-between">
                ...
                <div @click="isMenu = !isMenu" class="relative">
                    <button :disabled="isDeleting" class="flex items-center text-white p-1 h-[24px] w-[24px]
                    hover:bg-gray-800 rounded-full cursor-pointer" :class="isMenu ? 'bg-gray-800' : ''">
                    ...
                    <div v-if="isMenu" class="absolute border border-gray-600 right-0 z-20 mt-1 rounded">
                        <button class="flex items-center rounded gap-2 text-red-500 justify-between 
            ...
            <div class="relative flex items-center w-full">
                ...
                <div class="bg-black rounded-lg text-sm w-full font-light">
            ...
            <div class="flex items-center">
                <div class="flex items-center flex-wrap text-white gap-1 w-[42px]">
                    <div class="flex gap-0.5">
                        <img class="rounded-full h-[14px]" src="https://picsum.photos/id/202/50" alt="">
