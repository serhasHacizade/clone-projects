...
export const getSideBar = query({
    ...
    handler: async (ctx, args) => {
        ...
        const userId = identity.subject;
        const documents = await ctx.db.query("document").withIndex("by_user_parent", (q) =>
            q
                .eq("userId", userId)
...
export const getTrash = query({
    handler: async (ctx) => {
        ...
        const documents = await ctx.db
            .query("document").withIndex("by_user", (q) => q.eq("userId", userId))
...
export const getSearch = query({
    handler: async (ctx) => {
        ...
        const userId = identity.subject;
        const documents = await ctx.db.query("document").withIndex("by_user", (q) => q.eq("userId",userId))
...
export const getById = query({
    ...
    handler: async (ctx, args) => {
        ...
        if (!identity) throw new Error("Not auhthenticated!")
