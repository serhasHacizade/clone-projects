...
import Highligths from "@/components/Highlights.vue";
  ...
  <div class="max-w-[1500px] mx-auto">
    ...
    <div class="px-8 mt-8 min-w-[800px]">
      ...
      <p class="text-center pb-6 text-[#D1D1D6] text-sm">
        Unlock by selecting your favourite artists for improved recommendations.
      </p>
    ...
    <div class="px-8 mt-8 min-w-[800px]">
      ...
      <div class="flex items-center gap-8">
        <div class="rounded-lg w-1/2">
          <Highligths by="Some Artist 1" song="Awesome Song for you" image="https://picsum.photos/id/177/800/300"/>
        </div>
        <div class="rounded-lg w-1/2">
          <Highligths by="Some Artist 2" song="Another banger BRUV!" image="https://picsum.photos/id/229/800/300"/>
        </div>
      </div>
    </div>
    <div class="mt-8 min-w-[800px]">
