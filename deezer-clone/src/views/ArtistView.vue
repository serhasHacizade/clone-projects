...
<template>
  <div class="max-w-[1500px] mx-auto" id="header-section">
    <div
    ...
    <div class="flex justify-between pt-2 min-w-[650px]">
      <ul class="flex items-center justify-start w-full text-gray-400 h-9">
        <li class="pl-8">
          <button
            class="font-light cursor-pointer text-[#bebebe] border-b-2 border-b-[#121216] hover:border-b-[#FFFFFF] pb-[8px]"
          >
            Discography
          </button>
        </li>
  ...
  <div class="mb-10"></div>
  <div class="max-w-[1500px] mx-auto" id="SongsSection">
    <div class="pl-8">
      <h1 class="text-white text-3xl font-semibold mb-7">Top tracks</h1>
      <div
      ...
      >
        ...
        <input
          type="text"
          class="w-full py-[5px] bg-[#23232D] rounded-xl text-sm placeholder-[#7e7e7e] outline-none ring-0 hover:ring-0"
